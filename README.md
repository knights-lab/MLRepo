...
## Classify samples between antibiotic and control groups for large effect, or between antibiotics for small effect
...
## predict PCDAI scores based on samples
...
## May want to control for ZYGOSITY
